...
import io.nirahtech.ride4ever.motorcycleclub.garage.Motorbike;
import io.nirahtech.ride4ever.motorcycleclub.localization.Address;
...
public final class Biker implements Serializable {
    ...
    private Blood blood;
    private int weight;
    private boolean isOrganDonor = true;
